...
public class ListViewBaseAdapter extends BaseAdapter {
    ...
    public View getView(int itemIndex, View convertView, ViewGroup viewGroup) {
        ...
        {
            convertView = View.inflate(ctx, R.layout.listviewelement, null);



            TextView listItemText = (TextView) convertView.findViewById(R.id.name);
            TextView listItemText1 = (TextView) convertView.findViewById(R.id.mobno);
        ...
        viewHolder.getItemTextView1().setText(listViewItemDto.getMobno());
